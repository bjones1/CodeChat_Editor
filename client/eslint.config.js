...
export default defineConfig(
    ...
    defineConfig([
        ...
        },
        {
            ...
            rules: {
                ...
                "@typescript-eslint/naming-convention": [
                    ...
                    // Imports may keep whatever casing their source uses
                    // (PascalCase classes, UPPER_CASE constants, etc.), since
                    // we don't control the exporting library/module.
                    ...
                    {
                        selector: ["memberLike", "parameterProperty"],
                        format: ["camelCase"],
                        leadingUnderscore: "allow",
                        trailingUnderscore: "allow",
                    },
                    ...
                    // Object/type literal properties frequently mirror
                    // external APIs or wire formats we don't control (DOM
                    // datasets, CodeMirror options, JSON payloads), so leave
                    // their casing unconstrained.
                    {
        ...
        {
            // Generated by `ts-rs` from Rust struct definitions -- naming
            // mirrors the Rust source and must not be changed here.
            name: "rust-types",
            files: ["src/rust-types/**"],
            rules: {
