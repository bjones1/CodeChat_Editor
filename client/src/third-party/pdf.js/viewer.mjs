...
// Copied in the builder's `run_client_build` function.
const CMAP_URL = "/static/bundled/node_modules/pdfjs-dist/cmaps/";
const CMAP_PACKED = true;

pdfjsLib.GlobalWorkerOptions.workerSrc =
    "/static/bundled/node_modules/pdfjs-dist/build/pdf.worker.js";

// The search param provides the location of the file to view. Add the `raw`
// query string to get the actual PDF contents, instead of a Client Simple Viewer.
const DEFAULT_URL = window.location.search.substring(1) + "?raw";
