<p>Copyright (C) 2023 Bryan A. Jones.</p>
...
<ul>
    ...
    <li>Markdown is very well known, due to GitHub's use of it, and is more
        readable. Anything that can't be translated from HTML from Markdown can
        simply be left as HTML, since Markdown allows HTML as a part of its
        syntax.</li>
</ul>
...
<p style="padding-left: 40px;"><span style="color: rgb(0, 0, 0);">This
        implementation will transform files as normal, but instead of the code
        blocks undergoing the existing pipeline:</span></p>
<p style="padding-left: 80px;"><span style="color: rgb(0, 0, 0);">Load File
        --&gt; Convert to HTML --&gt; Write Stuff --&gt; Convert to HTML --&gt;
        Save File,</span></p>
<p style="padding-left: 40px;"><em><span style="color: rgb(0, 0, 0);">we will
            instead have:</span></em></p>
<p style="padding-left: 80px;">Load File --&gt; <strong>Convert to Markdown
    </strong>--&gt; Convert to HTML --&gt; Write Stuff --&gt; Convert to HTML
    --&gt; <strong>Convert to Markdown</strong> --&gt; Save File.</p>
<p style="padding-left: 40px;">To begin, we will be focusing on the
    <em>first</em> half of the pipeline, converting Markdown to HTML. We can
    simply convert Markdown to HTML using the pulldown-cmark crate, which
    should be implemented right after the doc and code blocks have been parsed.
</p>
<h4>CommonMark Info:</h4>
<ul>
    <li>Guide to using Markdown: visit <a
            href="https://www.markdownguide.org/getting-started/">this link</a>
    </li>
    <li>Specifications for CommonMark: see&nbsp;<a
            href="https://spec.commonmark.org/">this link</a></li>
    <li>To view CommonMark syntax, visit <a
            href="https://commonmark.org/help/">this link</a></li>
</ul>
<h4>Sources and Documentation for pulldown-cmark:</h4>
<ul>
    <li>To download: visit <a
            href="https://crates.io/crates/pulldown-cmark">this homepage
            link</a></li>
    <li>To view documentation for pulldown-cmark, visit <a
            href="https://docs.rs/pulldown-cmark/latest/pulldown_cmark/">this
            link</a></li>
    <li>By default, only CommonMark features are implemented.&nbsp;
        <ul>
            <li>To use tables, strikethrough text, footnotes, task lists, etc,
                we must enable them in the Options struct. See <a
                    href="https://docs.rs/pulldown-cmark/latest/pulldown_cmark/struct.Options.html">this
                    link</a> for details</li>
        </ul>
    </li>
</ul>
